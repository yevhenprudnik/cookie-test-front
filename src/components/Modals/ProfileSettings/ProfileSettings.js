    ...
    <div className="profile-modal">
      <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center cardModal">
        <main className="pa4 black-80 w-80">
          <img
            src={profileImage}
            className="h3 w3 dib br-100 highlight"
            alt="Profile Image"
          />
          <h1>{newName}</h1>
          ...
          >
            <button
              className="b br2 pa2 grow pointer hover-white w-40 bg-light-blue b--black-20"
              onClick={() => {
                if (!newName) {
                  Swal.fire({
                    icon: 'error',
            ...
            <button
              className="b br2 pa2 grow pointer hover-white w-40 bg-light-red b--black-20"
