    ...
    <div>
      ...
      <div className="comment-modal">
        <article className="br3 ba b--black-10 w-100 mw7 shadow-5 center cardModal">
          ...
          <div className="modal-close" onClick={() => setCommentModal(false)}>
            &times;
          </div>
        </article>
        <div className="AcommentDiv">
          <article className="br3 ba b--black-10 w-100 mw8 shadow-5 center cardModal">
            <main className="pa2 black-80 w-80">
              <div className="pb2">
                <label className="fw6" htmlFor="user-name">
                  Comment:
                </label>
              </div>
              <div className="">
              ...
              >
                <button
                  className="b1 br2 pa1 grow pointer hover-white w-20 bg-light-blue b--black-20"
                  onClick={() => {
                    if (comment) {
                      addComment({
                        userId,
                ...
                <button
                  className="b1 br2 pa1 grow pointer hover-white w-20 bg-light-red b--black-20"
